        ...
        public override void OnInspectorGUI()
        {
            ...
            if (isFeasibleTargetForPolyFew)
            {
                ...
                if (toolMainFoldout)
                {
                    ...
                    GUI.backgroundColor = UtilityServices.HexToColor("#E1E1E1");
...
#pragma warning disable
        ...
        public void DrawBatchFewUI(bool boxDrawnAlready = false)
        {
            ...
            if (FoldoutBatchFew)
            {
                ...
                RegardChildren = EditorGUILayout.Toggle(RegardChildren, GUILayout.Width(33), GUILayout.ExpandWidth(false));
                style.padding = oldPadding;
...
#region COMBINE MESHES
                ...
                if (didPressButton)
                {
                    ...
                    option = EditorUtility.DisplayDialogComplex("Generate Secondary UV Set",
                        "Should we generate uv2 with default settings for each mesh, and fill them in?. Note that generating uv2 can cause the mesh combining process to get slow.",
                        "No",
                        "Yes",
                        "Cancel");
