...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class PlayerJetBehavior : NetworkBehavior
	{
		...
		public PlayerJetNetworkObject networkObject = null;
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (PlayerJetNetworkObject)obj;
		...
		{
			Initialize(new PlayerJetNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new PlayerJetNetworkObject(networker, this, createCode, metadata);
		}
